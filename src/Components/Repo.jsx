      ...
      {repo ? (
        <div className="md:flex rounded-xl p-8">
          ...
          <div className=" md:p-8 md:h-58  text-left space-y-1">
            ...
            <button className="rounded-md p-2 text-white hover:bg-blue-800 bg-blue-300">
              <a href={repo.homepage} target="_blank">Project Live link</a>
            </button>

            <button className="rounded-md mt-6 md:mt-0 p-2 text-white hover:bg-blue-800 bg-blue-300 md:mx-7">
